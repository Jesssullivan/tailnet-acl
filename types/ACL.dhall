...
let ACLRule = { action : Text, src : List Text, dst : List Text }

let SSHRule =
      { action : Text, src : List Text, dst : List Text, users : List Text }

let NodeAttr = { target : List Text, attr : List Text }
